package com.github.ppartisan.sunshine.app.sync;
...
import com.github.ppartisan.sunshine.app.BuildConfig;
import com.github.ppartisan.sunshine.app.MainActivity;
import com.github.ppartisan.sunshine.app.R;
import com.github.ppartisan.sunshine.app.Utility;
import com.github.ppartisan.sunshine.app.data.WeatherContract;
import com.github.ppartisan.sunshine.app.muzei.WeatherMuzeiSource;
import com.github.ppartisan.sunshine.app.wearable.WeatherWearableIntentService;
...
import static com.github.ppartisan.sunshine.app.data.WeatherContract.WeatherEntry.COLUMN_SHORT_DESC;
...
public class SunshineSyncAdapter extends AbstractThreadedSyncAdapter implements GoogleApiClient.ConnectionCallbacks{
    ...
    private static final String WEARABLE_PATH = "/wearable";
    private static final String[] FORECAST_COLUMNS =
            { COLUMN_WEATHER_ID, COLUMN_MAX_TEMP, COLUMN_MIN_TEMP };

    private static final String[] NOTIFY_WEATHER_PROJECTION = new String[]
            { COLUMN_WEATHER_ID, COLUMN_MAX_TEMP, COLUMN_MIN_TEMP, COLUMN_SHORT_DESC };
    ...
    private void updateWearable() {
        Log.d(getClass().getSimpleName(), "Updating Wearable");
        getContext().startService(new Intent(getContext(), WeatherWearableIntentService.class));
    }
    ...
    public static void syncImmediately(Context context) {
        Log.d(SunshineSyncAdapter.class.getSimpleName(), "Sync Immediately");
